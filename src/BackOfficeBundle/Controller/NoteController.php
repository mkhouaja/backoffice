...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notes = $em->getRepository('BackOfficeBundle:Note')->findAll();
    ...
    {
        $note = new Note();
        $form = $this->createForm('BackOfficeBundle\Form\NoteType', $note);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('note_show', array('id_note' => $note->getId_note()));
        }
    ...
    private function createDeleteForm(Note $note)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('note_delete', array('id_note' => $note->getId_note())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
